...
NOTES = {
    ...
    "library.deleted_folder": "Where “Remove” moves a picture. Every removal is written to removals.jsonl in this folder — when it went, where it came from, and what it was. The Removed tab reads that file, can put a picture back, and can empty the trash: that deletes the files and keeps the lines about them.",
