...
NOTES = {
    ...
    "slideshow.order": "shuffle · random · date_desc · date_asc · name · folder · recent · least_played",
    ...
    "viewer.mat_style": "single · double · bevel · float · float_shadow · polaroid · random · `\"\"` for any",
    ...
    "viewer.show_text": "Any of: title, caption, name, date, location, folder, camera, exposure.",
